...
import ExcelFileUtilies.PropertyFileUtil;
public class FunctionLibray {
		...
		public static WebDriver startBrowser() throws Exception{
			...
			if(PropertyFileUtil.getValueForkey("Browser").equalsIgnoreCase("chrome")){
				System.setProperty("webdriver.chrome.driver","D:\\mahendar\\StockAccountingHybrid\\drivers\\chromedriver.exe");
			    driver=new ChromeDriver();
			}else if(PropertyFileUtil.getValueForkey("Browser").equalsIgnoreCase("firefox")){
				System.setProperty("webdriver.gecko.driver","D:\\mahendar\\StockAccountingHybrid\\drivers\\geckodriver.exe");
				driver=new FirefoxDriver();
			}else if(PropertyFileUtil.getValueForkey("Browser").equalsIgnoreCase("ie")){
				System.setProperty("webdriver.internetexplorer.driver","D:\\mahendar\\StockAccountingHybrid\\drivers\\IEDriverServer.exe");
		...
		public static void captureData(WebDriver driver,String locatortytpe,
			...
			FileWriter fw=new FileWriter("D:\\mahendar\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
